    ...
    document.addEventListener("impress:init", function (event) {
        ...
        document.addEventListener("keydown", function ( event ) {
            if (  event.keyCode === 70 || event.keyCode === 76 ||
                event.keyCode === 78 || event.keyCode === 79 || event.keyCode === 80 || event.keyCode === 9 || ( event.keyCode >= 32 && event.keyCode <= 34 ) || (event.keyCode >= 37 && event.keyCode <= 40) ) {
        ...
        document.addEventListener("keyup", function ( event ) {
            ...
            if ( event.keyCode === 70 || event.keyCode === 76 ||
                event.keyCode === 78 || event.keyCode === 79 || event.keyCode === 80 || event.keyCode === 9 ||
                ( event.keyCode >= 32 && event.keyCode <= 34 ) || (event.keyCode >= 37 && event.keyCode <= 40) ) {
